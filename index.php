...
<div class="jumbotron">
  <div class="container">
    <h1 class="display-4">WELCOME TO JORDAN MAP GIS</h1>
    <hr class="my-4">
    <p class="lead">WE WILL SERVICE YOU INTO EVERYWHERE AND ANYWHERE TO GO</p>
    <a class="btn btn-primary btn-lg font-weight-bold" href="#" role="button">VISIT HERE</a>
  </div>
</div>
